...
{
    internal abstract class VJSharpModifierAttributeConverter : TypeConverter
    {
        // Methods
        protected VJSharpModifierAttributeConverter()
        {
        }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            return ResourceHelper.GetString("Unknown_Modifier");
        }
