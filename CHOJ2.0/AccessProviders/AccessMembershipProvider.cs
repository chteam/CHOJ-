        ...
        public override MembershipUser CreateUser(string username,
            ...
            try {
                try {
                    ...
                    DateTime dt = AccessConnectionHolder.RoundToSeconds(DateTime.Now);
            ...
            try {
                try {
                    ...
                    if (RequiresQuestionAndAnswer) {
                        ...
                        if (!reader.Read()) { // No passwordAnswer!
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline) {
            ...
            try {
                try {
                    ...
                    DateTime dtLastActivity = userIsOnline ? AccessConnectionHolder.RoundToSeconds(DateTime.Now)
